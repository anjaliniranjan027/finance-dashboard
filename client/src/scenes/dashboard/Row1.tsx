...
const Row1 = ({ onBoxClick }: Row1Props) => {
                ...
                >
                  <defs>
                    <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor={(palette.primary as any)[300]} stopOpacity={0.5} />
                      <stop offset="95%" stopColor={(palette.primary as any)[300]} stopOpacity={0} />
                    </linearGradient>
            ...
            <DashboardBox>
              ...
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={revenue} margin={{ top: 17, right: 15, left: -5, bottom: 58 }}>
                  <defs>
                    <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor={(palette.primary as any)[300]} stopOpacity={0.8} />
                      <stop offset="95%" stopColor={(palette.primary as any)[300]} stopOpacity={0} />
                    </linearGradient>
                  </defs>
                  <CartesianGrid vertical={false} stroke={palette.grey[800]} />
